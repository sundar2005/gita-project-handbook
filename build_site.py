...
home=(f'<main class="wrap">'
 f'<section class="home-hero"><p class="kicker">Student Handbook · Version 1.0</p>'
 f'<h1>The GITA Project™</h1>'
 f'<p class="sub">An 18-week journey through the Bhagavad Gita — Scripture, Understanding Dharma, and Character — '
 f'for students discovering their own journey through life.</p></section>'
 f'{pillars}'
 f'<p style="margin:.4rem 0 .7rem"><a href="introduction.html">Start with the Introduction &#8250;</a> &nbsp;·&nbsp; <a href="how-to-use.html">How to use this book</a></p>'
 f'<p style="margin:0 0 1.6rem"><a class="dl-btn" href="The_GITA_Project_OpenEdition.epub" download>&#8681;&nbsp; Download the e-book (EPUB)</a> <span class="dl-note">~8&nbsp;MB · reflowable · opens in Apple Books, Google Play Books, or Kindle (via Calibre)</span></p>'
 f'<h2 class="sec" id="journey">The 18-Week Journey</h2>'
 f'<ul class="journey">{"".join(jrows)}</ul>'
 f'<h2 class="sec">Also in this book</h2>'
 f'<ul class="journey">'
 f'<li><a href="introduction.html"><span class="wk">Intro</span><span><span class="nm">Introduction</span> — <span class="th">Why this journey, the Three Pillars, the Court of Dharma</span></span></a></li>'
 f'<li><a href="how-to-use.html"><span class="wk">Guide</span><span><span class="nm">How to Use This Book</span> — <span class="th">the weekly rhythm, journey-at-a-glance, student covenant</span></span></a></li>'
